...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {!hideClose ? (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none text-text-tertiary hover:text-text-primary">
          <X className="h-4 w-4" />
