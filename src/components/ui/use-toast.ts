...
/**
 * useToast — lightweight global toast state manager.
 * Inspired by the standard shadcn pattern; works with the platform's
 * Toast primitives and a single mounted <Toaster />.
 */
